...
class LifetimeFeatureGenerator(fg.FeatureGenerator):
    ...
    def gen_data_df(self, will_generate_key):
        return pd.read_csv(self.data_csv_path, index_col='id')
    ...
    def gen_divided_by(self, data, will_generate_key, re_args):
